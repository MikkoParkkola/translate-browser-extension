...
- **Ternary Bonsai 4B status**: `docs/TERNARY_BONSAI_EVALUATION.md` records the #511 NO-GO decision for a direct browser-extension replacement because the public 4B artifacts target MLX or GGUF, not the current `@huggingface/transformers` WebGPU/WebNN runtime.
