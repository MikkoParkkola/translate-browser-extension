...
- [x] **WebGPU batch inference** — TranslateGemma now batches non-empty prompts into capped padded tensor chunks instead of one model dispatch per segment. MIK-3472 includes ordering/fallback tests and a scheduler benchmark harness.
