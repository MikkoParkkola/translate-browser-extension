;(function(root){
  ...
  const Actions = new Set([
    'translate','translateText','translateBatch',
    'ping','get-usage-log','set-config','clear-remote-tm','tm-get-all','tm-clear','tm-import','tm-stats',
    'debug','get-security-audit','usage','metrics','tm-cache-metrics','quota','detect','translation-status','get-status','get-stats',
    'recalibrate','ensure-start','ensure-core-modules',
    'home:init','home:get-usage','home:quick-translate','home:auto-translate','navigate',
