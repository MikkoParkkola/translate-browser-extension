...
var UIManager = (typeof self !== 'undefined' && typeof self.qwenUIManager === 'function') ? self.qwenUIManager : null;
if (!UIManager) {
class UIManagerDef {
  constructor(logger) {
    this.logger = logger;
...
UIManager = UIManagerDef;

if (typeof self !== 'undefined') {
  self.qwenUIManager = UIManager;
  if (typeof self.UIManager === 'undefined') {
